 ...
 */
/*
Important NOTE: BinaryImage setPixel and getPixel have the wrong parameters (height, width) instead
of (width, height). They are used in lots of places so I don't want to refactorize for now (too little
time). This code will just follow the order of parameter set in BinaryImage's code
 */
...
//                    }
//                } else {
////                    if (binaryImage.getPixel(y, x) == BinaryImage.BLUE) {
////                        while (x < binaryImage.getWidth() && binaryImage.getPixel(y, x) == BinaryImage.BLUE) {
////                            x++;
////                        }
////                        x--;
////                    }
...
//            binaryImage.fillRect(i, y, 1, 1, BinaryImage.RED);
...
//            binaryImage.fillRect(x, j, 1, 1, BinaryImage.RED);
